...
from models import db, User, Review, reviews_schema, review_schema, private_review_schema, private_reviews_schema
...
def get_private_review(current_user_token):
    ...
    reviews = Review.query.filter_by(user_token = a_user).all()
